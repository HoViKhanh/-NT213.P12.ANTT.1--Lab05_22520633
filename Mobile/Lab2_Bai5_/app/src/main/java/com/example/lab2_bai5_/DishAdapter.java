...
public class Bai4_FoodAdapter extends BaseAdapter {
    ...
    private int layout;
    private ArrayList<com.example.lab02.Bai4_Food> bai4FoodList =null;


    public Bai4_FoodAdapter(Context context, int layout, ArrayList<com.example.lab02.Bai4_Food> bai4FoodList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        com.example.lab02.Bai4_Food monan = bai4FoodList.get(position);
